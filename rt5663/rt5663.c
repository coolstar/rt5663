...
)
{
	...
	*Complete = TRUE;
...

	{
		...
		WDF_WORKITEM_CONFIG_INIT(&workitemConfig, Rt5663IdleIrpWorkItem);
...
)
{
	...
	case IOCTL_HID_SEND_IDLE_NOTIFICATION_REQUEST:
		...
		status = Rt5663ProcessIdleRequest(devContext, Request, &completeRequest);
		break;
